...
(function () {
  ...
  function mountMark() {
    ...
    /* 兩條的筆刷寬度不同，是量出來的：
       左線中途會「穿過」兩帶交會處 —— 筆刷 >82 就會順便露出外圈那條的根部，
       看起來就像畫到一半突然冒出一截線（v15 用 86 就是這個毛病）。所以左線 82。
       右線只在最後一刻才到交會處，寬一點(95)剛好把接口填滿，也碰不到隔壁那圈(98px 外)。 */
    [['opzPfA', D_RIGHT, '95'], ['opzPfB', D_LEFT, '82']].forEach(function (p) {
