...
'    <li><a href="recent-jobs.html">Recent Jobs</a></li>',
...
'      <span class="account-name" id="navAccountName">My Account</span>',
'      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><polyline points="6 9 12 15 18 9"/></svg>',
'    </button>',
...
'    <a href="messages.html" style="font-weight:700;">Messages <span class="nav-msg-badge" id="dropMsgBadge" style="display:none;background:#e05;color:#fff;border-radius:50px;padding:1px 7px;font-size:10px;font-weight:700;margin-left:auto;">0</span></a>',
'    <div class="nav-login-vsep"></div>',
'    <a href="customer-profile.html#bookings">My Bookings</a>',
'    <div class="nav-login-vsep"></div>',
'    <a href="customer-profile.html">My Profile</a>',
'    <div class="nav-login-vsep"></div>',
'    <a href="#" id="navLogoutBtn" style="color:#c00">Log Out</a>',
'  </div>',
'',
'  <!-- MEGA MENU -->',
...
'</div>'
  ...
  var NAV_I18N = {
    en: {
      ...
      'menu.piano':'Piano','menu.pipeorgan':'Pipe Organ',
    ...
    zh: {
      ...
      'menu.piano':'鋼琴','menu.pipeorgan':'管風琴',
